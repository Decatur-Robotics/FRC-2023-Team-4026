...
public class Ports
{
   ...
   { // TODO: Assign port values for each module
      ...
      // Rear right
      public final static int MOD1_DRIVEMOTOR = 1;
      public final static int MOD1_ANGLEMOTOR = 7;
      public final static int MOD1_CANCODER = 1;

      // Front left
      public final static int MOD2_DRIVEMOTOR = 4;
      public final static int MOD2_ANGLEMOTOR = 8;
      public final static int MOD2_CANCODER = 4;
